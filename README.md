...
- **Daily review across all decks (🔁 Wiederholung)** — one tap under the deck panel drills *every word you have ever studied*, no matter which deck it came from and whether that deck is currently active: studied yesterday in three different decks, repeat them all together today — and the pool grows automatically as you learn more. Rounds are dealt in your "Pro Runde" size, most-urgent words first (closest to their due date), with a "Weiter wiederholen (n übrig)" button chaining chunks until you've been through everything, then the cycle restarts. It's pure extra exposure: everything runs as an ungraded practice round, so your SM-2 intervals are never distorted
